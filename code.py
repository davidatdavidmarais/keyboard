...
keyboard.keymap = [
    ...
    [
     ...
     XXXXXXX,               XXXXXXX,      XXXXXXX,        KC.OS(KC.MEH),         KC.HT(KC.ENT, KC.LGUI),        KC.HT(KC.TAB, KC.FD(1)),                           KC.HT(KC.BSPC,KC.FD(2)),        KC.SPC,           KC.OS(KC.RSFT),         XXXXXXX,       XXXXXXX,         XXXXXXX
    ],
    # Lower layer
    [
     _______,      KC.EXLM,      KC.AT,        KC.HASH,      KC.DLR,       KC.PERC,                                                                         KC.CIRC,      KC.AMPR,      KC.ASTR,      KC.LPRN,       KC.RPRN,      _______,
     KC.P0,        KC.P1,        KC.P2,        KC.P3,        KC.P4,        KC.P5,                                                                           KC.P6,        KC.P7,        KC.P8,        KC.P9,                       KC.DQUO,
